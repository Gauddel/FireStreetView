 ...
 */
  ...
  .config(['$routeProvider', function($routeProvider) {
    $routeProvider
      ...
      .when('/accountvalidation', {
        templateUrl:'views/validation.html',
        controller: 'AccountValidationCtrl'
      })
      .when('/addstreetview', {
        templateUrl: 'views/addstreetview.html',
        controller: 'AddStreetViewCtrl',
        controllerAs: 'vm'
      })
      .when('/streetview/:panoId', {
      ...
      .when('emailvalidation?mode&oobCode', {
        templateUrl: 'emailvalidation.html',
